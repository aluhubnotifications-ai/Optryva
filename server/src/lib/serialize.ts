...
export function rowToProfile(r: any, includePrivate = false) {
  ...
  return {
    ...
    graduated: r.graduated ? true : undefined,
...
export function rowToApplication(r: any) {
  ...
  return {
    ...
    resume_id: r.resume_id ?? undefined,
    resume_snapshot: r.resume_snapshot ? j.parse(r.resume_snapshot, undefined) : undefined,
    resume_changed: !!r.resume_changed,
